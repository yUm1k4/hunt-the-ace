...
function createCard(cardItem) {
    ...
    // assign class to back image elemnt of back of card
    ...
    // add front card element as child element to card inner element
    addChildElement(cardInnerElem, cardFrontElem);

    // add back card element as child element to card inner element
